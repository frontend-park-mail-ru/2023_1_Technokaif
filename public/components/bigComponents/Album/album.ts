...
export class Album extends BaseComponent {
    ...
    protected addSubscribes() {
        ...
        ContentStore.subscribe(
            () => {
                const state = ContentStore.state.ALBUM;
                const img :HTMLImageElement|null = document.querySelector('.album__img');
